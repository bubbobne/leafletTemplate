angular.module('starter.controllers', []).controller('AppCtrl', ['$scope', '$ionicModal', '$timeout', function ($scope, $ionicModal, $timeout) {
    ...
    .controller('MapCtrl', ['$scope', '$cordovaGeolocation', 'leafletData', 'markersApi', '$ionicModal', '$ionicLoading', function ($scope, $cordovaGeolocation, leafletData, markersApi, $ionicModal, $ionicLoading) {
